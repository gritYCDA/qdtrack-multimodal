...
class Motmetrics_evaluation:
    ...
    def initialize_base(self,ground_truth,working_dir_path):
        ...
        try:
            ...
            self.gt_frame_numbers_cam = set(self.ground_truth["Frame#"].tolist())
    ...
    def evaluate(self,motmetrics_distance=Motmetrics_distance.norm2squared_matrix):
        ...
        for frame_no_cam in self.gt_frame_numbers_cam: #Will go through all frame_number of one cam
            ...
            try:
                ...
                gt_rows_this_frame = self.ground_truth[self.ground_truth["Frame#"] == frame_no_cam]
            ...
            if motmetrics_distance == Motmetrics_distance.norm2squared_matrix:
                ...
                try:
                    ...
                    gt_points_this_frame = list(zip(gt_rows_this_frame["x"], gt_rows_this_frame["y"]))
                ...
                try:
                    ...
                    gt_bboxes_this_frame = list(zip(gt_rows_this_frame["x"]
                                                    ,gt_rows_this_frame["y"]
                                                    ,gt_rows_this_frame["x"] + gt_rows_this_frame["width"]
                                                    ,gt_rows_this_frame["y"] + gt_rows_this_frame["height"]))
...
def evaluate_one_cam_task(ground_truth,track_results,working_dir,cam_id):
    ...
    if isinstance(ground_truth, str):
        try:
            ...
            scenario_name = ground_truth.split('/')[-1]
            ground_truth = os.path.join(ground_truth, f"NIA_MTMDC_{scenario_name}_c{cam_id+1:02}_pm_sunny_summer.csv")
